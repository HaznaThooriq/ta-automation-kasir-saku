...
public class TransaksiPPOBController {
    ...
    public void createTransaksiPPOBInvalidAuth() {
        ValidatableResponse response = given().header("Authorization", "Basic YTJGemFYSmZjMkZyZFRwTpXWldMVGgwVUVGdk9EbE9SR2M9Og==")
                .baseUri("http://api.kasirsaku.sahabatdeveloper.site")
                .formParam("jumlah_bayar", "20000")
                .formParam("jenis_pembayaran", "pulsa")
                .formParam("kode_pelanggan", "085330438009")
    ...
    public void indexTransaksiPPOBInvalidAuth() {
        ValidatableResponse response = given().header("Authorization", "Basic YTJGemFYSmZwVUVGdk9EbE9SR2M9Og==")
                .baseUri("http://api.kasirsaku.sahabatdeveloper.site")
                .basePath("/v1/transaksi-ppob")
                .when().post("/index")
                .then().statusCode(401);
    ...
    public void viewTopupPPOBInvalidId() {
        ValidatableResponse response = given().header("Authorization", "Basic YTJGemFYSmZjMkZyZFRwTlpXWldMVGgwVUVGdk9EbE9SR2M9Og==")
                .baseUri("http://api.kasirsaku.sahabatdeveloper.site")
                .basePath("/v1/transaksi-ppob")
                .when().post("/view?id={id}", "-1000000000")
                .then().statusCode(404);
